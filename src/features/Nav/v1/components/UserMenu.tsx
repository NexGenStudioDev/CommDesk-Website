  ...
  if (!isAuthenticated) {
    return (
      <div className="hidden items-center gap-3 xl:flex">
        ...
        <button
          onClick={onAuthToggle}
          className="rounded-full bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:bg-primary/90 active:scale-95"
        >
          Get Started
        </button>
      </div>
                ...
                <div className="space-y-3 p-4">
                  <div className="rounded-xl border border-border bg-muted/30 p-3">
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      Your team replied to the latest post.
                    </p>
                  </div>
                  <div className="rounded-xl border border-border bg-muted/30 p-3">
                    <p className="text-sm font-medium">Event reminder</p>
                    <p className="mt-1 text-xs text-muted-foreground">
                      CommDesk Sync starts in 30 minutes.
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            <>
              ...
              >
                ...
                <div className="p-2 border-t border-border">
                  <button
                    onClick={onAuthToggle}
                    className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                  >
